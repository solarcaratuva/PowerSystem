...
2) Add extra CAN port (need one for Rx from BMS, and one for Tx and Rx to other PCBs) as well as the external CAN Tranceivers
3) Make sure everything has footprint and 3d model
